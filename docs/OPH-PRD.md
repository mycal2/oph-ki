...
| P1 | OPH-72–81: Salesforce App (10 features) | In Review | See [Salesforce App PRD](./SALESFORCE-PRD.md) |
| P1 | OPH-82: Außendienstler Menu in Stammdaten Sidebar | In Review |
| P1 | OPH-83: Show Sales Rep Identity on Salesforce App Orders | Planned |
...
| P1 | OPH-87: Salesforce App: Personalized Login Page | Deployed |
| P1 | OPH-88: Salesforce App: Order History Search & Date Filter | Deployed |
| P1 | OPH-89: Außendienstler: Edit Name & Status | Deployed |
...
| P1 | OPH-104: Tenant Price Lookup Feature Flag | Deployed |
| P1 | OPH-105: Article RRP (Recommended Retail Price) Field | Deployed |
| P1 | OPH-106: Customer Discount Rates Management | Deployed |
| P1 | OPH-107: Discount Rate Excel Export & Import | Deployed |
| P1 | OPH-108: Price Lookup in AI Extraction | Deployed |
...
| P1 | OPH-113: 6-Digit OTP Code Fallback for Defender-Resistant Auth | In Progress |
